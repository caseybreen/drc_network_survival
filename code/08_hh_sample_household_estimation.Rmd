...
age_specific_cdr <- age_specific_cdr %>%
...
hh_death_rate_health_zones %>%
  ggsave(filename = here("figures/hh_death_rate_health_zones.png"), height = 8, width = 6)
```
...
education_disparities_plot %>%
  ggsave(filename = here("figures/education_disparities.png"), height = 5, width = 7)
```
