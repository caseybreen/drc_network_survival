---
title: "Generate weights - don't drop enum 11"
author: "Casey Breen" 
---
...
survey_df <- read_csv(here("data/data_clean/quota_sample_survey.csv")) %>% 
  select(-weight_poststrat, -weight_ipw)
...
```{r}
## write csv 
write_csv(death_weighted, here("data", "data_clean", "quota_sample_deaths_enum11.csv"))
write_csv(survey_df_weighted, here("data", "data_clean", "quota_sample_survey_enum11.csv"))
```
