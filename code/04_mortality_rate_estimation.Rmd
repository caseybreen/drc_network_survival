...
cdr_pooled_bootstrap <- networksurvival::compute_cdr_comprehensive(death_df = death_df,
                                                                        survey_df = survey_df,
                                                                        weight_col = "weight_poststrat", bootstrap = 10000) 
...
preregistered_estimates <- cdr_estimates %>% 
  ...
  select(type, weights, zone_de_sante_name, month, death_rate, death_rate_lower, death_rate_upper)


write_csv(preregistered_estimates, here("data", "preregistered_estimates", "preregistered_estiamtes.csv"))
```
