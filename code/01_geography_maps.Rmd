...
Summary: Create a map of Tanganyika Province / study sites 
...
# The dTolerance parameter controls the degree of simplification
...
ggsave(plot = combined_geo_plot, filename = here("figures/combined_geo_plot.png"), bg = "white", width = 14, height = 7)
