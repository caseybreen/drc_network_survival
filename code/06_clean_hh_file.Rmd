...
Summary: Format household dataset 
...
hh_data <- readxl::read_excel(path = here("data", "clean_data", "hh_survey_data.xlsx"), col_types = "text") %>%
...
# hh_data <- read_excel("data/hh_survey_data.xlsx", col_types = "text")
write_csv(final_hh_data, path = here("data", "clean_data", "hh_survey_data_clean.csv")) 
```
